...
/**
 * Create by fz on 2020/4/6
 */
public class SingleLinkedListDemo {
    public static void main(String[] args) {
        SingleLinkedList s1 = new SingleLinkedList();
        s1.addByOrder(new HeroNode(1,"",""));
        s1.addByOrder(new HeroNode(3,"",""));
        s1.addByOrder(new HeroNode(5,"",""));
        s1.addByOrder(new HeroNode(7,"",""));

        SingleLinkedList s2 = new SingleLinkedList();
        s2.addByOrder(new HeroNode(2,"",""));
        s2.addByOrder(new HeroNode(4,"",""));
        s2.addByOrder(new HeroNode(6,"",""));
        s2.addByOrder(new HeroNode(8,"",""));
...
class SingleLinkedList {
    ...
    public SingleLinkedList sortTwoLists(SingleLinkedList list1) {
        ...
        HeroNode temp = null;
        while (temp1 != null) {
            temp = new HeroNode(temp1.no,temp1.name,temp1.nickname);
